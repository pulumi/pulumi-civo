...
public final class GetSizeFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetSizeFilterArgs Empty = new GetSizeFilterArgs();
    ...
    private GetSizeFilterArgs() {}

    private GetSizeFilterArgs(GetSizeFilterArgs $) {
        this.all = $.all;
        this.key = $.key;
    ...
    public static Builder builder(GetSizeFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSizeFilterArgs();
        }

        public Builder(GetSizeFilterArgs defaults) {
            $ = new GetSizeFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSizeFilterArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetSizeFilterArgs", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetSizeFilterArgs", "values");
            }
            return $;
        }
    }
