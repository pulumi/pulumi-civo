...
public class KubernetesNodePool extends com.pulumi.resources.CustomResource {
    ...
    public KubernetesNodePool(java.lang.String name, KubernetesNodePoolArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("civo:index/kubernetesNodePool:KubernetesNodePool", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private KubernetesNodePool(java.lang.String name, Output<java.lang.String> id, @Nullable KubernetesNodePoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("civo:index/kubernetesNodePool:KubernetesNodePool", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static KubernetesNodePool get(java.lang.String name, Output<java.lang.String> id, @Nullable KubernetesNodePoolState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
