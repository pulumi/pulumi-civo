...
public final class GetKubernetesVersionFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetKubernetesVersionFilterArgs Empty = new GetKubernetesVersionFilterArgs();
    ...
    private GetKubernetesVersionFilterArgs() {}

    private GetKubernetesVersionFilterArgs(GetKubernetesVersionFilterArgs $) {
        this.all = $.all;
        this.key = $.key;
    ...
    public static Builder builder(GetKubernetesVersionFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetKubernetesVersionFilterArgs();
        }

        public Builder(GetKubernetesVersionFilterArgs defaults) {
            $ = new GetKubernetesVersionFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param key Filter versions by this key. This may be one of `default`, `label`, `type`, `version`.
         * 
         * @return builder
         * 
         */
        ...
        public GetKubernetesVersionFilterArgs build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetKubernetesVersionFilterArgs", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetKubernetesVersionFilterArgs", "values");
            }
            return $;
        }
    }
