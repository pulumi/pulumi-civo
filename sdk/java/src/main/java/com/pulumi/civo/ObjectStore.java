...
public class ObjectStore extends com.pulumi.resources.CustomResource {
    ...
    /**
     * @return The access key id of the Object Store. It is generated by the provider.
     * 
     */
     ...
     * 
     */
    @Export(name="generatedName", type=String.class, parameters={})
    private Output<String> generatedName;

    /**
     * @return The generated name of the Object Store. It is generated by the provider.
     * 
     */
    public Output<String> generatedName() {
    ...
    /**
     * @return The secret access key of the Object Store. It is generated by the provider.
     * 
     */
    ...
    public ObjectStore(String name, @Nullable ObjectStoreArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("civo:index/objectStore:ObjectStore", name, args == null ? ObjectStoreArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
