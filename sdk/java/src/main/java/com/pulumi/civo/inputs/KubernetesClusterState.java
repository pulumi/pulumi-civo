...
import com.pulumi.civo.inputs.KubernetesClusterInstalledApplicationArgs;
...
public final class KubernetesClusterState extends com.pulumi.resources.ResourceArgs {
    ...
    public Optional<Output<String>> dnsEntry() {
        return Optional.ofNullable(this.dnsEntry);
    }
    ...
    public Optional<Output<String>> masterIp() {
        return Optional.ofNullable(this.masterIp);
    }
    ...
    @Import(name="pools")
    private @Nullable Output<KubernetesClusterPoolsArgs> pools;

    public Optional<Output<KubernetesClusterPoolsArgs>> pools() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder dnsEntry(@Nullable Output<String> dnsEntry) {
            $.dnsEntry = dnsEntry;
            return this;
        }
        ...
        public Builder dnsEntry(String dnsEntry) {
            return dnsEntry(Output.of(dnsEntry));
        }
         ...
         * 
         */
        public Builder masterIp(@Nullable Output<String> masterIp) {
            $.masterIp = masterIp;
            return this;
        }
        ...
        public Builder masterIp(String masterIp) {
            return masterIp(Output.of(masterIp));
        }
        ...
        public Builder pools(@Nullable Output<KubernetesClusterPoolsArgs> pools) {
            $.pools = pools;
            return this;
        }
