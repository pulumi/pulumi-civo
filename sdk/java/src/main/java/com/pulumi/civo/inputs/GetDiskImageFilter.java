...
public final class GetDiskImageFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetDiskImageFilter Empty = new GetDiskImageFilter();
    ...
    private GetDiskImageFilter() {}

    private GetDiskImageFilter(GetDiskImageFilter $) {
        this.all = $.all;
        this.key = $.key;
    ...
    public static Builder builder(GetDiskImageFilter defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDiskImageFilter();
        }

        public Builder(GetDiskImageFilter defaults) {
            $ = new GetDiskImageFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetDiskImageFilter build() {
            if ($.key == null) {
                throw new MissingRequiredPropertyException("GetDiskImageFilter", "key");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetDiskImageFilter", "values");
            }
            return $;
        }
    }
