...
@CustomType
public final class GetSizeFilter {
    /**
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetSizeFilter", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetSizeFilter", "values");
            }
            this.values = values;
            return this;
        }
