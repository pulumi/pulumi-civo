...
public class ObjectStoreCredential extends com.pulumi.resources.CustomResource {
     ...
     */
    public ObjectStoreCredential(java.lang.String name) {
     ...
     */
    public ObjectStoreCredential(java.lang.String name, @Nullable ObjectStoreCredentialArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ObjectStoreCredential(java.lang.String name, @Nullable ObjectStoreCredentialArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("civo:index/objectStoreCredential:ObjectStoreCredential", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ObjectStoreCredential(java.lang.String name, Output<java.lang.String> id, @Nullable ObjectStoreCredentialState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("civo:index/objectStoreCredential:ObjectStoreCredential", name, state, makeResourceOptions(options, id), false);
    }

    private static ObjectStoreCredentialArgs makeArgs(@Nullable ObjectStoreCredentialArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ObjectStoreCredentialArgs.Empty : args;
    }
     ...
     */
    public static ObjectStoreCredential get(java.lang.String name, Output<java.lang.String> id, @Nullable ObjectStoreCredentialState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
