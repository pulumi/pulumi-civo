...
func (i *ObjectStoreCredential) ToOutput(ctx context.Context) pulumix.Output[*ObjectStoreCredential] {
	return pulumix.Output[*ObjectStoreCredential]{
		OutputState: i.ToObjectStoreCredentialOutputWithContext(ctx).OutputState,
	}
}
...
func (i ObjectStoreCredentialArray) ToOutput(ctx context.Context) pulumix.Output[[]*ObjectStoreCredential] {
	return pulumix.Output[[]*ObjectStoreCredential]{
		OutputState: i.ToObjectStoreCredentialArrayOutputWithContext(ctx).OutputState,
	}
}
...
func (i ObjectStoreCredentialMap) ToOutput(ctx context.Context) pulumix.Output[map[string]*ObjectStoreCredential] {
	return pulumix.Output[map[string]*ObjectStoreCredential]{
		OutputState: i.ToObjectStoreCredentialMapOutputWithContext(ctx).OutputState,
	}
}
...
func (o ObjectStoreCredentialOutput) ToOutput(ctx context.Context) pulumix.Output[*ObjectStoreCredential] {
	return pulumix.Output[*ObjectStoreCredential]{
...
func (o ObjectStoreCredentialArrayOutput) ToOutput(ctx context.Context) pulumix.Output[[]*ObjectStoreCredential] {
	return pulumix.Output[[]*ObjectStoreCredential]{
		OutputState: o.OutputState,
	}
}
...
func (o ObjectStoreCredentialMapOutput) ToOutput(ctx context.Context) pulumix.Output[map[string]*ObjectStoreCredential] {
	return pulumix.Output[map[string]*ObjectStoreCredential]{
		OutputState: o.OutputState,
	}
}
