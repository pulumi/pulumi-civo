...
class Template(pulumi.CustomResource):
    def __init__(__self__,
        ...
        :param pulumi.Input[str] cloud_config: Commonly referred to as 'user-data', this is a customisation script that is run afterthe instance is first booted. We
               ...
               information)
        :param pulumi.Input[str] code: This is a unqiue, alphanumerical, short, human readable code for the template (required).
        :param pulumi.Input[str] default_username: The default username to suggest that the user creates (optional: defaults to civo).
        :param pulumi.Input[str] description: A multi-line description of the template, in Markdown format (optional).
        :param pulumi.Input[str] image_id: This is the Image ID of any default template or the ID of another template,either owned by you or global (optional; but
               must be specified if no volume_id is specified).
        :param pulumi.Input[str] name: This is a short human readable name for the template (optional).
        :param pulumi.Input[str] short_description: A one line description of the template (optional)
        :param pulumi.Input[str] volume_id: This is the ID of a bootable volume, either owned by you or global(optional; but must be specified if no image_id is
               specified).
        """
